...
import net.AzureWare.mod.mods.MOVEMENT.EntitySpeed;
...
public class EntityHorse extends EntityAnimal implements IInvBasic {
	...
	public void moveEntityWithHeading(float strafe, float forward) {
		if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLivingBase && this.isHorseSaddled()) {
			...
			if (ModManager.getModByName("EntitySpeed").isEnabled()) {
				if (forward == 0.0D && strafe == 0.0D) {
					...
					if (forward != 0.0D) {
						if (strafe > 0.0D) {
							this.rotationYaw += (float) (forward > 0.0D ? -45 : 45);
						} else if (strafe < 0.0D) {
							this.rotationYaw += (float) (forward > 0.0D ? 45 : -45);
						}
					...
					this.motionX = forward * EntitySpeed.speed.getValueState()
							* Math.cos(Math.toRadians((double) (this.rotationYaw + 90.0F)))
							+ strafe * EntitySpeed.speed.getValueState()
									* Math.sin(Math.toRadians((double) (this.rotationYaw + 90.0F)));
					this.motionZ = forward * EntitySpeed.speed.getValueState()
							* Math.sin(Math.toRadians((double) (this.rotationYaw + 90.0F)))
							- strafe * EntitySpeed.speed.getValueState()
									* Math.cos(Math.toRadians((double) (this.rotationYaw + 90.0F)));
				}
