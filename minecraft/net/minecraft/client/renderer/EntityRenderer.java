...
import net.AzureWare.mod.mods.COMBAT.Reach;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            double d0 = ModManager.getModByName("Reach").isEnabled() ? Reach.blockrange.getValueState() : (double)this.mc.playerController.getBlockReachDistance();
            this.mc.objectMouseOver = entity.rayTrace(ModManager.getModByName("Reach").isEnabled() ? Reach.reach_reach.getValueState() : d0, partialTicks);
            double d1 = d0;
           ...
           //     d0 = d0;
			...
			if(ModManager.getModByName("Reach").isEnabled()) {
            	d1 = Reach.reach_reach.getValueState();
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (ModManager.getModByName("Reach").isEnabled() ? Reach.reach_reach.getValueState() : 3.0D))
            {
                this.pointedEntity = null;
    ...
    {
        if(ModManager.getModByName("NoHurtcam").isEnabled())return;
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3 && !ModManager.getModByName("ViewClip").isEnabled())
                        {
                            d3 = d7;
                        }
                    }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventRender event = new EventRender(pass, partialTicks, finishTimeNano);
