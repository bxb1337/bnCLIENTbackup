...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("Client/mainMenu/backGround.png");
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.guiLogin = new GuiLogin(Minecraft.getMinecraft().currentScreen);
        new Client();
    }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Minecraft 1.8.8 | " + Client.CLIENT_NAME + " " + Client.CLIENT_VERSION + " | Loading...");
	...
	private void setWindowIcon() {
		...
		if (util$enumos != Util.EnumOS.OSX) {
			...
			try {
				...
				inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("Client/icon16.png"));
				inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("Client/icon32.png"));
    ...
    private void runGameLoop() throws IOException
    {
		...
		if(thePlayer != null) {
			Client.playerName = thePlayer.getName();
		}
