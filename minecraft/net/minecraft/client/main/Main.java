...
public class Main {
	...
	public static void main(String[] p_Main_0_) {
		...
		OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Debug_User",
				new String[0]);
		...
		if (optionspec19 == null) {
			list = ("Free");
		} else {
			list = optionset.valuesOf((OptionSpec)nonOptionArgumentSpec).toString();
			System.out.println(optionset.valuesOf((OptionSpec)nonOptionArgumentSpec).toString());
		}

		// System.out.println(Wrapper.crackme());
