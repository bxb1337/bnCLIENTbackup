...
public class GuiOptionSlider extends GuiButton
{
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            RenderUtil.drawRect(
            		this.xPosition + (int)(this.sliderValue * (float)(this.width - 8)) + 2, 
            		this.yPosition,
            		this.xPosition + (int)(this.sliderValue * (float)(this.width - 8)) + 6,
            		this.yPosition+20, 
            		new Color(0x006fb6).brighter().getRGB());
            RenderUtil.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, (float)(this.yPosition + this.height) + 1.5f, ClientUtil.reAlpha(Colors.BLACK.c, (float)super.animation * 2.0f));
