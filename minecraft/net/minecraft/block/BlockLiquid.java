...
import net.AzureWare.events.EventLiquidCollide;
...
public abstract class BlockLiquid extends Block
{
    ...
    {
        EventLiquidCollide e = new EventLiquidCollide(this, pos, new AxisAlignedBB((double)pos.getX() + this.minX, (double)pos.getY() + this.minY, (double)pos.getZ() + this.minZ, (double)pos.getX() + this.maxX, (double)pos.getY() + this.maxY, (double)pos.getZ() + this.maxZ));
        EventManager.call(e);
        return e.isCancelled()?e.getBounds():null;
    }
