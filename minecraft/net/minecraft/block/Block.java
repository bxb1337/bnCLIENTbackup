...
import net.AzureWare.mod.mods.RENDER.XRay;
import net.AzureWare.mod.mods.WORLD.FastDig;
...
public class Block
{
    ...
    public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        int i = worldIn.getCombinedLight(pos, Xray ? 100000 : block.getLightValue());
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        if (Xray && this == Block.getBlockById(16)) {
            return true;
        }
        if (Xray) {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity)
    {
        ...
        EventBoundingBox event = new EventBoundingBox(axisalignedbb, state.getBlock(), pos.getX(), pos.getY(), pos.getZ());
        Client.getInstance().getEventMgr().call(event);
    ...
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos)
    {
         ...
         if(f < 0.0F) {
            ...
            if(!playerIn.canHarvestBlock(this)) {
               speed = playerIn.getToolDigEfficiency(this) / f / 100.0F;
            } else {
               speed = playerIn.getToolDigEfficiency(this) / f / 30.0F;
            }

            return !ModManager.getModByName("FastDig").isEnabled()?speed:speed * FastDig.speed;
         }
    }
